...
module.exports = __webpack_require__(/*! /Users/dfranks/projects/experiments/phaser-es6-webpack/src/main.js */333);
...
var _Head = __webpack_require__(/*! ../sprites/Head */ 91);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      this.emitter.setScale(0.1, .4, 0.1, .4, 2000, _phaser2.default.Easing.Exponential.Out);
    ...
    key: 'update',
    value: function update() {
      var angle = (this.head.angle + 50) * 0.017453292;
...
var _Litter = __webpack_require__(/*! ../sprites/Litter */ 341);

var _Litter2 = _interopRequireDefault(_Litter);

var _Pumpkin = __webpack_require__(/*! ../sprites/Pumpkin */ 342);

var _Pumpkin2 = _interopRequireDefault(_Pumpkin);

var _Cat = __webpack_require__(/*! ../sprites/Cat */ 343);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      this.game.physics.enable([this.head, this.ground], _phaser2.default.Physics.ARCADE);
      ...
      this.emitter = game.add.emitter();
      this.emitter.setScale(0.1, .3, 0.1, .3, 2000, _phaser2.default.Easing.Exponential.Out);
      this.emitter.makeParticles('blood1');
      this.emitter.lifespan = 500;
    }
  }, {
    ...
    key: 'createLitter',
    value: function createLitter() {
      return new _Litter2.default({
        game: this.game,
    ...
    key: 'createPumpkin',
    value: function createPumpkin() {
      return new _Pumpkin2.default({
        game: this.game,
